...
<body class="bg-gray-50 min-h-screen bg-[url('/public/images/background.svg')] bg-no-repeat bg-bottom bg-fixed">
    ...
    <div class="flex flex-col justify-center p-6 pb-12">
        <div class="mx-auto max-w-md">        
            ...
            <h2 class="mt-2 sm:mt-6 text-2xl sm:text-3xl font-bold text-gray-900">Подтвердите новый пароль</h2>
        </div>
        <div class="bg-white/80 backdrop-blur-xl mt-6 sm:mt-10 p-6 sm:p-10 mx-auto rounded-xl shadow-xl max-w-md w-full">
            <form action="#" autocomplete="off" class="space-y-6" method="post">
                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700">Новый пароль</label>
                    <div class="relative rounded-md shadow-sm mt-1">
                        ...
                        focus:ring-gray-500 text-sm w-full" placeholder="Ваш новый пароль">
                    </div>
                </div>
                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700">Подтвердите пароль</label>
                    <div class="relative rounded-md shadow-sm mt-1">
                        <div class="absolute left-0 inset-y-0 flex items-center pl-3">
                            <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                ...
                <div>
                    ...
                    hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 transition duration-150 ease-in-out">Подтвердить</a>
                </div>
            </form>
        </div>
    </div>
