...
<head>
    ...
    <title>Отправить ссылку для сброса</title>
        ...
        <div class="bg-white/80 backdrop-blur-xl mt-6 sm:mt-10 p-6 sm:p-10 mx-auto rounded-xl shadow-xl max-w-md w-full">
            ...
            <form action="#" autocomplete="off" method="post">
                ...
                <div>
                    ...
                    hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 transition duration-150 ease-in-out">Отправить ссылку для сброса</button>
                </div>
            </form>
        </div>
    </main>
