            ...
            <form action="#" autocomplete="off" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative rounded-md shadow-sm mt-1">
                        ...
                        <input type="text" id="name" name="name" required class="pl-10 border-gray-300 rounded-md focus:border-violet-500
                        focus:ring-violet-500 text-sm w-full" placeholder="Ваше имя">
                    </div>
                </div>
                <div>
                    ...
                    <p class="mt-2 text-sm text-red-600">Ваша почта должна быть действительной</p>
                </div>
                <div>
                    ...
                    <div class="relative rounded-md shadow-sm mt-1">
                        ...
                        <input type="password" id="password" name="password" minlength="8" class="pl-10 border-gray-300 rounded-md focus:border-violet-500
                        focus:ring-violet-500 text-sm w-full" placeholder="Ваш пароль">
                    </div>
                </div>
                <div>
                    ...
                    <div class="relative rounded-md shadow-sm mt-1">
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation" minlength="8" class="pl-10 border-gray-300 rounded-md focus:border-violet-500
                        focus:ring-violet-500 text-sm w-full" placeholder="Ваш пароль">
                    </div>
                </div>
                <div>
